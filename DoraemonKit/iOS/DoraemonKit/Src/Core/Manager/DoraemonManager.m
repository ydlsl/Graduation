...
- (void)initData{
    #pragma mark - 毕设部分
    [self addPluginWithPluginType:DoraemonManagerPluginType_DoraemonNetFlowPlugin_school];
    [self addPluginWithPluginType:DoraemonManagerPluginType_DoraemonLargeImageFilter_school];
    [self addPluginWithPluginType:DoraemonManagerPluginType_DoraemonWeakNetworkPlugin_school];
    [self addPluginWithPluginType:DoraemonManagerPluginType_DoraemonMockPlugin_school];
    [self addPluginWithPluginType:DoraemonManagerPluginType_DoraemonAllTestPlugin_school];
...
- (DoraemonManagerPluginTypeModel *)getDefaultPluginDataWithPluginType:(DoraemonManagerPluginType)pluginType
{
    NSArray *dataArray = @{
                          ...
                          @(DoraemonManagerPluginType_DoraemonHierarchyPlugin) : @[
                           ...
                           //毕设区域
                           @(DoraemonManagerPluginType_DoraemonMockPlugin_school) : @[
                               @{kTitle:DoraemonLocalizedString(@"数据Mock")},
                                  @{kDesc:DoraemonLocalizedString(@"Mock数据修改")},
                                  @{kIcon:@"doraemon_mock"},
                                  @{kPluginName:@"DoraemonMockPlugin"},
                                  @{kAtModule:DoraemonLocalizedString(@"毕设区域")},
                                  @{kBuriedPoint:@"dokit_sdk_platform_ck_mock"}
                                  ],
                           @(DoraemonManagerPluginType_DoraemonWeakNetworkPlugin_school) : @[
                                   @{kTitle:DoraemonLocalizedString(@"模拟弱网")},
                                   @{kDesc:DoraemonLocalizedString(@"模拟弱网测试")},
                                   @{kIcon:@"doraemon_weaknet"},
                                   @{kPluginName:@"DoraemonWeakNetworkPlugin"},
                           ...
                           @(DoraemonManagerPluginType_DoraemonNetFlowPlugin_school) : @[
                               @{kTitle:DoraemonLocalizedString(@"流量")},
                               @{kDesc:DoraemonLocalizedString(@"流量监控")},
                               @{kIcon:@"doraemon_net"},
                               @{kPluginName:@"DoraemonNetFlowPlugin"},
                           ...
                           @(DoraemonManagerPluginType_DoraemonLargeImageFilter_school) : @[
                               @{kTitle:DoraemonLocalizedString(@"大图检测")},
                               @{kDesc:DoraemonLocalizedString(@"大图检测")},
                               @{kIcon:@"doraemon_largeImage"},
                               @{kPluginName:@"DoraemonLargeImagePlugin"},
                           ...
                           @(DoraemonManagerPluginType_DoraemonAllTestPlugin_school) : @[
                           @{kTitle:DoraemonLocalizedString(@"性能数据")},
                           @{kDesc:DoraemonLocalizedString(@"性能数据")},
                           @{kIcon:@"doraemon_self"},
